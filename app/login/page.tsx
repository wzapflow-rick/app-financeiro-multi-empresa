...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Simulando autenticação - substitua por autenticação real
    try {
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full px-12">
          <div className="text-center">
            ...
            <p className="text-xl text-white/90 max-w-md mx-auto leading-relaxed">
              Gerencie suas finanças de forma inteligente com controle total sobre suas empresas
            </p>
          </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden mb-8 text-center">
            <Image
              ...
              priority
            />
            <p className="text-muted-foreground mt-2">FINANÇAS</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded border-input bg-secondary/50 text-emerald-500 focus:ring-emerald-500"
                />
          ...
          <div className="mt-12 pt-8 border-t border-border text-center">
            <p className="text-xs text-muted-foreground">
              2024 ZapFlow Finanças. Todos os direitos reservados.
            </p>
          </div>
        </div>
      </div>
